...
<div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900/60">
  ...
  <form action="/Admin/informasi/store" method="post" class="space-y-6">
    <?= csrf_field(); ?>
    ...
    <div>
      ...
      <?php else: ?>
        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Opsional. Isi jika ingin menampilkan gambar pendukung.</p>
      <?php endif; ?>
    </div>
