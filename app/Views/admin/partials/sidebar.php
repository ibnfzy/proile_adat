    ...
    <nav x-data="{selected: $persist('Dashboard')}">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <li>
            <a href="/Admin/artikel" class="menu-item group">
          ...
          <li>
            <a href="/Admin/galeri" class="menu-item group">
          ...
          <li>
            <a href="/logout" class="menu-item group">

              <svg class="menu-item-icon-inactive" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                viewBox="0 0 16 16">
