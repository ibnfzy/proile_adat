...
<div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900/60">
  <div class="mb-6">
    <h3 class="text-2xl font-semibold text-gray-800 dark:text-white">Tambah Artikel</h3>
  ...
  <form action="/Admin/artikel/store" method="post" class="space-y-6">
    <?= csrf_field(); ?>
      ...
      <div>
        ...
        <select name="kategori_id" id="kategori_id"
          ...
          <?php foreach ($categories as $category): ?>
            <option value="<?= esc($category['id']); ?>" <?= old('kategori_id') == $category['id'] ? 'selected' : ''; ?>>
              <?= esc($category['nama']); ?>
            </option>
          <?php endforeach; ?>
        </select>
      ...
      <div>
        ...
        <select name="penulis_id" id="penulis_id"
          ...
          <?php foreach ($authors as $author): ?>
            <option value="<?= esc($author['id']); ?>" <?= old('penulis_id') == $author['id'] ? 'selected' : ''; ?>>
    ...
    <div>
      ...
      <input type="text" name="gambar" id="gambar" value="<?= old('gambar'); ?>"
    ...
    <div>
      ...
      <textarea name="isi" id="isi" rows="8"
        ...
        placeholder="Tuliskan isi artikel secara lengkap..."><?= old('isi'); ?></textarea>
